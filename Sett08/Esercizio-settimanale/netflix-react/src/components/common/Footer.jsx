    ...
    <>
      <footer className='mt-5 bg-black' style={{ width: 800 }}>
        <div className='footer-content d-flex py-3 flex-column'>
          ...
          <Row>
            <div className='col-12 text-center button-link'>
              <Button variant='outline' className='text-white border radius-3'>
                Service Code
              </Button>
            </div>
          </Row>
          <Row>
            <div className='footer-copyright col-12 text-left'>
