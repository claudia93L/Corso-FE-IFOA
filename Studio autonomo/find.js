...
//   Trova la prima stringa in un array di stringhe che contiene la lettera 'a' utilizzando find().

//   Trova il primo numero divisibile per 7 in un array di numeri utilizzando find().

//   Trova la prima parola in un array di stringhe che è in maiuscolo utilizzando find().

//   Trova la prima data nel passato in un array di date utilizzando find().

//   Trova il primo numero maggiore di 50 in un array di numeri utilizzando find().

//   Trova la prima stringa in un array di stringhe che rappresenta una frase utilizzando find().

//   Trova il primo valore false in un array di booleani utilizzando find().

// FIND - Array di oggetti
...
//   Trova il primo studente nell'array studenti che ha ottenuto un punteggio superiore a 90 in matematica utilizzando find().

//   Trova il primo ordine nell'array ordini con lo stato 'completato' utilizzando find().
