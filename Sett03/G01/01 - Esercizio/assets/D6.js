...
function trovaFilm(titoloCercato){
  const filmCercato = movies.find(film => film.Title === titoloCercato);
  return filmCercato;
}

console.log(`Il film cercato è ${trovaFilm('The Lord of the Rings')}`);
